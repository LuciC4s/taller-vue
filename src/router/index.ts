...
const router = createRouter({
  ...
  routes: [
    ...
    { path: '/tareas', name: 'tareas', component: () => import('@/views/TaskView.vue'), meta: { requiresAuth: true } },
    { path: '/tareas/nueva', name: 'tareas-nueva', component: () => import('@/views/TaskForm.vue'), meta: { requiresAuth: true } },
